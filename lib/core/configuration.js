...
const ALLOWED_SETTINGS = new Set(["openaiContext", "pricingBasis", "regionalMultiplier"]);
...
function normalizeConfiguration(source = {}) {
  ...
  return {
    revision,
    settings: { openaiContext, pricingBasis, regionalMultiplier },
    prices,
  };
}
...
function pricingOptionsFromConfiguration(options, configuration) {
  ...
  return {
    ...
    pricingRevision: normalized.revision,
  };
}
