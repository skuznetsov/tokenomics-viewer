...
const PRICING = {
  ...
  omp: {
    models: {
      // PLACEHOLDER — replace with official GLM/Zhipu AI pricing (OI-S1)
      // USD per 1M tokens. Values below are placeholders, not real prices.
      "glm-5.2": { input: 1.00, cacheCreate5m: 1.25, cacheCreate1h: 2.00, cacheRead: 0.10, output: 5.00 },
    },
  },
};
